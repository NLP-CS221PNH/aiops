...
Protocol `cs221-aiops-rag-protocol-v1` · version `1.0.0-draft.2` · **draft, chờ review người thật**.
...
Gói review cần đủ charter, protocol MD/YAML, decision log có owner/hạn, 8–12 bài với mức đọc thật, working agreement, thư nháp, issue log và manifest kiểm hash được. G0 chỉ đạt sau review độc lập của người thật và xác nhận trách nhiệm; chưa có những chữ ký này. Quyền API/payload/local/sharing/budget tách riêng và không tự được cấp khi G0 đạt. Các bất biến, thống kê và freeze sequence nằm trong [research protocol](research-protocol.md).

| Vai trò đề xuất | Tên thật | Review được giao | Trạng thái |
|---|---|---|---|
