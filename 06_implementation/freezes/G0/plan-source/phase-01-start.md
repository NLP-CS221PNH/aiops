...
- [ ] **01.1.1**: Charter nháp có đường dẫn nguồn; Codex / reviewer agent độc lập xác nhận bằng chứng.
- [ ] **01.1.2**: 90 incidents, 54/18/18, 0 judgments ghi đúng; Codex / reviewer agent độc lập xác nhận bằng chứng.
- [ ] **01.1.3**: Thư nháp; không gửi; Codex / reviewer agent độc lập xác nhận bằng chứng.
- [ ] **01.1.4**: Decision log có role owner/reviewer và hạn theo dõi; Codex / reviewer agent độc lập xác nhận bằng chứng.
...
- [ ] Reviewer agent độc lập kiểm bảng hiện trạng/source hashes và lưu review đúng actor_type; không cần chữ ký người thật theo amendment.
