...
from .common import (DEFAULT_CONFIG, ROOT, IMPL, FILES, DataContractError,
                     canonical_hash, load_config, parse_json, read_jsonl, require,
                     safe_path, sha256, timestamp, write_json)


def validate_inputs(config_path=DEFAULT_CONFIG, source_root=ROOT):
