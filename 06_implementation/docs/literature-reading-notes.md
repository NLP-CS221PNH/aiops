...
Theo [amendment tự nghiệm thu](acceptance-amendment.md), task01.2.2 được nghiệm thu bằng việc Codex đọc các phần đã ghi và agent độc lập kiểm nguồn, mức đọc, task-match cùng giới hạn. Các cột human_read_status/human_review_status giữ pending vì không có việc đọc của người thật được ghi nhận; chúng không chặn plan01 theo chỉ dẫn mới.
