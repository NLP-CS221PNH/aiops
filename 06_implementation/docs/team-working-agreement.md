...
Protocol `cs221-aiops-rag-protocol-v1` · version `1.0.0-reviewed.1` · **Codex kiểm thiết kế phân công và khả năng thực hiện; tên/giờ nhóm chưa xác minh**.

Tám tuần tương đối, ba thành viên; W1 bắt đầu khi nhóm xác nhận ngày khởi động. Ngày/hạn môn học, tên A/B/C, giờ cam kết và lịch giờ cụ thể đều pending. Theo [ủy quyền tự nghiệm thu](acceptance-amendment.md), Codex kiểm phân công vai trò, tổng công, lịch và các kịch bản thiếu nguồn lực để hoàn tất plan01. Tên/giờ không được tự điền; phần đọc/review Codex có evidence riêng.
...
Biểu mẫu ghi sự thật về thành viên, không là gate của plan01 theo amendment mới. Handoff artifact được Codex kiểm theo từng bên nhận trong protocol-review; communication tới người khác chưa gửi, status pending. Giảng viên quyết định quyền model/rubric, nhóm quyết trần chi và trách nhiệm theo thẩm quyền; mỗi quyết định cần chứng cứ lưu được.
