...
- [x] **01.2.1**: Protocol nháp thống nhất F1/F2; Codex / reviewer agent độc lập xác nhận bằng chứng.
- [x] **01.2.2**: Literature matrix với mức đọc thật; Codex / reviewer agent độc lập xác nhận bằng chứng.
- [x] **01.2.3**: Working agreement và tuần tương đối; Codex / reviewer agent độc lập xác nhận bằng chứng.
- [x] **01.2.4**: Decision log và protocol YAML; Codex / reviewer agent độc lập xác nhận bằng chứng.
...
- [x] Protocol mô tả công bằng, mẫu số, failed records và primary contrast trước test.
- [x] 8–12 bài có nguồn, mức đọc Codex thật và reviewer agent độc lập đối chiếu provenance; không giả human reading.
- [x] Mỗi hạng mục có role owner/reviewer khác, lịch/nguồn lực là đề xuất và giờ thực có vẫn unknown; kế hoạch annotation chấm đôi thật ở plan sau giữ nguyên.
- [x] Quyền API/local và trần chi vẫn pending nếu chưa có chứng cứ đồng ý.
